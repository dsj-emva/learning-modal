...
| [0014](0014-context-contract.md) | Context contract: five enum judgments + reason, four-field lead card, parse vs transport errors, stamped rows, cache keyed by card/brief/prompt/model | Accepted | `phase6-context-agent` |
| [0016](0016-context-acceptance-on-coefficients.md) | Context acceptance on coefficients (R12): weight CI excludes 0 and lies in the oracle CI; persona pooled to buyer / non_buyer / unclear at the feature level (R13-R15) | Accepted | `phase6-context-agent` |
