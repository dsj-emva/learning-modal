...
| [0013](0013-rolling-origin-headline-definition.md) | Rolling-origin headline: training mature at the split, one-month mature test windows, mean AUC over sufficient splits on v2 | Proposed | `reports/phase4.md` |
